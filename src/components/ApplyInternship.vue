    ...
    <div class="container">
      ...
      <div class="form-container">
        <header class="application-header">
          ...
          <p>
            Start your career journey with us through our internship program!
          </p>
        </header>
          ...
          <form @submit.prevent="submitApplication">
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                id="college-location"
                v-model="form.collegeLocation"
                placeholder="Enter your college location (city, state)"
                required
              />
            </div>

            <!-- Position Applied For (default to Internship) -->
            <div class="form-group">
...
export default {
  data() {
    return {
      form: {
        ...
        college: "",
        collegeLocation: "",
        position: "Internship", // Default to Internship
        resume: null,
      },
    };
  },
  methods: {
    ...
    async submitApplication() {
      ...
      formData.append("college_location", this.form.collegeLocation);
    ...
    resetForm() {
      this.form = {
        ...
        college: "",
        collegeLocation: "",
        position: "Internship", // Reset to Internship
        resume: null,
      };
